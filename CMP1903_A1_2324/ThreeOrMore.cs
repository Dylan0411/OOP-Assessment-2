...
namespace CMP1903_A1_2324
{
    internal class ThreeOrMore
    {
        ...
        public List<int> RollTheDie(int threeDie)
        {
            //EMPTY LIST
            DiceRollsList.Clear();
            ...
            {
                D1Value = threeDie; //Calls the 'roll' method in the 'dice1' object and assigns the returned value to 'D1Value' variable.
                DiceRollsList.Add(D1Value);
                Console.WriteLine("1st Dice Roll: " + D1Value);
                D2Value = threeDie; //Calls the 'roll' method in the 'dice2' object and assigns the returned value to 'D2Value' variable.
                DiceRollsList.Add(D2Value);
                Console.WriteLine("2nd Dice Roll: " + D2Value);
                D3Value = dice3.Roll();
                DiceRollsList.Add(D3Value);
